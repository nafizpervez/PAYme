...
class EducationSavedBill extends StatefulWidget {
  EducationSavedBill({Key? key}) : super(key: key);

  @override
  State<EducationSavedBill> createState() => _EducationSavedBillState();
}

class _EducationSavedBillState extends State<EducationSavedBill> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(() {
          return BillHistory(
            title: 'Education Bill Transection History',
            tabEntitites: _educationBillController.educationBillHistory
                .map(
                  (e) => [
