...
// List<PostpaidBillItems> westzonepostpaidfields = [
//   PostpaidBillItems(
//     'bill_period',
//     'Bill Period',
//     'grahok_number',
...
class PayPostpaidWESTZONE extends StatefulWidget {
  const PayPostpaidWESTZONE({Key? key}) : super(key: key);

  @override
  State<PayPostpaidWESTZONE> createState() => _PayPostpaidWESTZONEState();
}

class _PayPostpaidWESTZONEState extends State<PayPostpaidWESTZONE> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: PayElectricBill(
          assetimage: 'assets/sample/westzone_postpaid.png',
        ),
        ...
        //   ),
        //   child: Column(
        //     children: westzonepostpaidfields
        //         .map(
