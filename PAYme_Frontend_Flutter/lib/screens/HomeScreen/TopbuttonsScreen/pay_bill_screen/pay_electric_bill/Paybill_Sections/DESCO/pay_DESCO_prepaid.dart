...
// List<PrepaidBillItems> descoprepaidfields = [
//   PrepaidBillItems(
//     'account_no',
//     'Account No.',
//     'contact_number',
...
class PayPrepaidDESCO extends StatefulWidget {
  const PayPrepaidDESCO({Key? key}) : super(key: key);

  @override
  State<PayPrepaidDESCO> createState() => _PayPrepaidDESCOState();
}

class _PayPrepaidDESCOState extends State<PayPrepaidDESCO> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: PayElectricBill(
          assetimage: 'assets/sample/desco_prepaid.png',
        ),
